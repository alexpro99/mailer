        ...
        <div class="p-2 m-3">
            <form class="grid grid-cols-1">
                <div class="m-1 w-full">
                    ...
                    <x-jet-input id="topic" wire:model='topic' type="text" class="mt-1 block w-full" />
                    <x-jet-input-error for="topic" class="mt-2" />
                </div>
                <div class="m-1 w-full">
                    <x-jet-label for="destiny" value="{{ __('To:') }}" />
                    <x-jet-input id="destiny" wire:model='destiny' type="email" class="mt-1 block w-full" />
                    <x-jet-input-error for="destiny" class="mt-2" />
                </div>
                <div class="m-1 w-full">
                    <x-jet-label for="body" value="{{ __('Body:') }}" />
                    <textarea id="body" wire:model='body' rows="8" class="block px-0 w-full text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write your email..." required></textarea>
